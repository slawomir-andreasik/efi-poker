...
export function NotFoundPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
      ...
      <p className="text-xl text-efi-text-primary mb-2 animate-[fade-in-up_0.6s_ease-out_0.1s_both] motion-reduce:animate-none">Page Not Found</p>
      <p className="text-efi-text-secondary mb-8 animate-[fade-in-up_0.6s_ease-out_0.2s_both] motion-reduce:animate-none">The page you are looking for does not exist.</p>
      <Link
        to="/"
